...
既定でタグ(`@v0.1.1`)にバージョンを固定している。最新の開発版(main)を使う場合は `@v0.1.1` を外す。
...
```bash
RIGOL_MCP_FAKE=1 uvx --from git+https://github.com/zinntikumugai/rigol-oscilloscope-mcp@v0.1.1 rigol-oscilloscope-mcp
```
