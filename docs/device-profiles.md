...
出典は公式プログラミングガイド(DHO800/900: **PGA39106-1110** / DHO1000/4000: **PGA34101-1110**)のみで、**実機は未検証**(`confidence: guide`)。ガイドに逐語で載っているニモニックだけを宣言し、実機挙動に依存する項目は宣言しない。シリーズ別の対応状況一覧は [compatibility.md](compatibility.md)。
