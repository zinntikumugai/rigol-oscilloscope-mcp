"""safety/classes.py のテスト(Requirements.md 6.1 / tools.md 10章)。"""
...
# docs/tools.md 10章のサマリ表(Phase 1/2/4 + M1/M2/M3 + 開発用 raw_scpi)
EXPECTED = {
    "connect": "SAFE_WRITE",
    ...
    "configure_reference": "SAFE_WRITE",
    "get_reference_state": "READ_ONLY",
